...
public class MyBratNameSampleStream extends SegmenterObjectStream<BratDocument, NameSample> {
  ...
  protected MyBratNameSampleStream(SentenceDetector sentDetector,
  ...
  protected MyBratNameSampleStream(SentenceModel sentModel, TokenizerModel tokenModel,
  ...
  protected List<NameSample> read(BratDocument sample) throws IOException {
    ...
    public ObjectStream<BratDocument> getSamples() {
        return samples;
    }
